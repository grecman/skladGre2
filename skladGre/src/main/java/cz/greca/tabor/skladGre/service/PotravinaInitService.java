...
@Service
public class PotravinaInitService {

	static Logger log = Logger.getLogger(PotravinaInitService.class);
	...
	public void init() throws ParseException {
		...
		log.debug("###\t Zakladam seznam potravin (dosavadni budou smazany).");
