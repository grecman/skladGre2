...
@Controller
public class PotravinaPlneniController {
	...
	private static final Logger log = Logger.getLogger(PotravinaPlneniController.class);

	@RequestMapping(value = "/potravinyPlneni")
	public String potravinyPlneni(FormObject formObject) throws ParseException {
		log.debug("###\t potravinyPlneni()");
