...
<body>
	<div class="page">
		...
		<div class="mainAreaWide">
			<div class="formBar">
				<form:form commandName="formObject" action="${pageContext.servletContext.contextPath}/enterLogin">
					...
					<SPAN> <form:input path="password" id="password" class="textovePole" cssStyle="width:160px; color:#dfe0e0;"></form:input> <input type="submit"
